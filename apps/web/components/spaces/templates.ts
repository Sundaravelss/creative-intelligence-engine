 ...
 *
 * This file deliberately is NOT marked `"use client"` so server components
 * (e.g. `generateStaticParams` in `app/(app)/spaces/[id]/page.tsx`) can
 * iterate the array at build/request time.
 */
